...
public class CollectorsDemo {
    public static void main(String[] args) {
        ...
        //toList() : returns a Collector interface that gathers input data into a new List
        List<Integer> numberList2 = numbers.stream()
                .filter(x -> x % 2 == 0)
                .collect(Collectors.toList());

        //toSet() : returns a Collector interface that gathers input data into a new Set
